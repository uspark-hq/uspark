...
### Phase 1: Unblock Core Pipeline
1. **Fix E2B container**
   - Install uspark CLI in Dockerfile
   - Test container initialization
   - Verify Claude Code + uspark integration

2. **Implement Session APIs**
   - Create Turn API that calls E2B
   - Connect to E2B runtime
...
### Phase 2: Complete Story 3
1. **Frontend Templates**
   - Hardcode 4 templates in frontend
   - Add template buttons to chat UI
   - Simple variable replacement

2. **Polling System**
   - Implement useSessionPolling hook
