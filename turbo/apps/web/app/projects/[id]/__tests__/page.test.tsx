...
vi.mock("../../../components/file-explorer", () => ({
  YjsFileExplorer: vi.fn(({ projectId, onFileSelect, selectedFile, showMetadata }) => (
...
describe("Project Detail Page", () => {
  ...
  it("renders page with correct project ID", () => {
    ...
    expect(screen.getByRole("heading", { name: "Project: test-project-123" })).toBeInTheDocument();
    expect(screen.getByText("Browse files and collaborate with Claude Code")).toBeInTheDocument();
  ...
  it("renders main layout sections", () => {
    ...
    // Chat Input section
    expect(screen.getByPlaceholderText("Ask Claude Code to modify your project files...")).toBeInTheDocument();
  ...
  it("renders chat input with proper styling and interaction", () => {
    ...
    const textarea = screen.getByPlaceholderText("Ask Claude Code to modify your project files...");
    ...
    expect(screen.getByText(/Try: "Add error handling to the login function"/)).toBeInTheDocument();
  ...
  it("handles different project IDs from params", () => {
    ...
    expect(screen.getByRole("heading", { name: "Project: another-project-456" })).toBeInTheDocument();
    expect(screen.getByText("Project ID: another-project-456")).toBeInTheDocument();
  });
