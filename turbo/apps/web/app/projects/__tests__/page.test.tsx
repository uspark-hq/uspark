...
describe("Projects List Page", () => {
  ...
  it("renders page header correctly", async () => {
    ...
    expect(screen.getByText("Manage and collaborate on your projects with Claude Code")).toBeInTheDocument();
  ...
  it("handles project creation", async () => {
    ...
    await waitFor(() => {
      expect(mockPush).toHaveBeenCalledWith(expect.stringMatching(/^\/projects\/project-\d+$/));
    });
  });
