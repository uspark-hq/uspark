...
function createDemoYjsDocument(): Uint8Array {
  ...
  demoFiles.forEach((file, index) => {
    ...
    const hash = `hash_${btoa(file.path)
      .replace(/[^a-zA-Z0-9]/g, "")
      .substring(0, 8)}`;
  ...
  return (
    ...
    >
      <header style={{ marginBottom: "30px" }}>
        ...
        >
          This demo shows how the file explorer component parses file structures
          from YJS documents.
        </p>
        ...
        >
          ...
          <ul style={{ margin: 0, paddingLeft: "20px", lineHeight: "1.5" }}>
            <li>
              YJS document contains two maps: <code>files</code> (metadata) and{" "}
              <code>blobs</code> (size info)
            </li>
            <li>
              File paths are keys in the <code>files</code> map with hash and
              modification time values
            </li>
            <li>
              The component automatically builds a tree structure from flat file
              paths
            </li>
            <li>
              Real projects would have content stored in separate blob storage
            </li>
          </ul>
        </div>
      </header>
            ...
            {selectedFile ? (
              <div>
                ...
                >
                  ...
                  >
                    In a real application, this would show file content,
                    modification time, and other metadata from the YJS document.
                  </div>
                </div>
              </div>
            ) : (
